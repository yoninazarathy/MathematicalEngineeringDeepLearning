...
| Figure | Topic           | Source Code          |
| ------ | --------------- | -----------          |
| 3.1    | Logistic regression model curves | [R(a,b)](https://github.com/yoninazarathy/MathematicalEngineeringDeepLearning/blob/master/R/R-code-logistic-smooth-link.R)  |        
